...
class SourceBox:
    ...
    def post_user_collection(self, udsid, data):
        return self.get(self.source_base + "collections/" + udsid, data, method="POST")
        
    def delete_user_collection(self, udsid, data):
        return dict(self._request(self.source_base + "collections/" + udsid, data, method="DELETE").items())
